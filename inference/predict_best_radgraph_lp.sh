...
allennlp evaluate \
	...
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_bertbase.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_bertbase.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_bertlarge.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_bertlarge.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_debertav3base.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_debertav3base.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_electrabase.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_electrabase.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_gatortron.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_gatortron.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_pubmedbert.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_pubmedbert.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_radbert1.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_radbert1.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_radbert2.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_radbert2.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_robertabase.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_robertabase.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_robertalarge.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_robertalarge.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_bioclinicalbert.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_bioclinicalbert.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_biolinkbertbase.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_biolinkbertbase.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_debertav3large.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_debertav3large.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_electralarge.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_electralarge.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_electrasmall.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_electrasmall.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_mimiccxr_test_biolinkbertlarge.json 
...
allennlp evaluate \
	...
	--cuda-device 0 \
	--include-package dygie \
	--output-file /dataNAS/people/jmz/jmz_code/radiology_nlp/rales/results/re/radgraph_lp_chexpert_test_biolinkbertlarge.json 
