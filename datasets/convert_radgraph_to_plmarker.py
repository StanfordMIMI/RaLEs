"""
Converts RadGraph dataset to PLMarker 

Radgraph dataset:
https://physionet.org/content/radgraph/1.0.0/

PLMarker format:
https://github.com/thunlp/PL-Marker/blob/07fde08d868134ced1d861d17d263d6c782bb420/README.md
...
def main():
    ...
    for fname in ['train','dev','test']:
        ...
        if fname != 'test':            
            write_jsonl(parsed_contents, f'{radgraph_dir}{fname}_plmarker_jsonl.json')
        else:
            for data_source in ['MIMIC-CXR','CheXpert']:
                ...
                write_jsonl(relevant_contents, f'{radgraph_dir}{fname}_{data_source}_plmarker_jsonl.json')
